...
public class CheckedTextViewC extends androidx.appcompat.widget.AppCompatCheckedTextView {
    ...
    public void setTypeface(Typeface tf, int style) {
        if(!this.isInEditMode()){
            Typeface normalTypeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/Font-Light.ttf");
            Typeface boldTypeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/Font-Light.ttf");
